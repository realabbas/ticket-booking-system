...
<html>
<head>
<title>Ticket Booking System DBMS Project</title>
        ...
        <form action="process_search.php" id="reservation-form" method="post" onsubmit="myFunction()">
		       <fieldset>
		       	<div class="field" >
                                ...
                                <input type="text" placeholder="Search Matches Here..." style="height:27px;width:500px"  required id="search111" name="search">
