...
-- INSERT INTO `tbl_match` (`ticket_id`, `t_id`, `ticket_name`, `type`, `desc`, `match_date`, `image`, `video_url`, `status`) VALUES
...
INSERT INTO `tbl_news` (`news_id`, `name`, `type`, `news_date`, `description`, `attachment`) VALUES
...
-- INSERT INTO `tbl_shows` (`s_id`, `st_id`, `theatre_id`, `ticket_id`, `start_date`, `status`, `r_status`) VALUES
...
-- (14, 'Trinity Matches', 'Pathanamthtta', 'Pathanamthitta, Kerala, India', 'Kerala', 691554);
